...
https://discord.gg/JdXPTvutMj

--]]

if getgenv().cuppink then warn("Beyond Hub : Already executed!") return end
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Beyond Hub - Premium",
    SubTitle = " (discord.gg/JdXPTvutMj)",
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/JdXPTvutMj")
        end
    })
